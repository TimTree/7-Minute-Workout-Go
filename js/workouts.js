...
const allWorkouts = [
  /* Cardio */ [ // 9
    ...
    { name: "Stand and Box",
      img1:"./img/StandAndBox1.png",
      img2:"./img/StandAndBox2.png",
      img3:"./img/StandAndBox1.png",
      img4:"./img/StandAndBox2.png",
    },
    { name: "Pretend Jump Rope",
      img1:"./img/PretendJumpRope1.png",
      img2:"./img/PretendJumpRope2.png",
      img3:"./img/PretendJumpRope1.png",
      img4:"./img/PretendJumpRope2.png",
    },
  ],
  /* Upper/Lower Body */ [ // 9
    { name: "Wall Sit",
    ...
    { name: "Pike Push Up",
      img1:"./img/DownwardDog.png",
      img2:"./img/PikePushUp.png",
      img3:"./img/DownwardDog.png",
      img4:"./img/PikePushUp.png",
    },
    { name: "Side Lunges",
      img1:"./img/JumpingJack1.png",
      img2:"./img/SideLunge1.png",
      img3:"./img/JumpingJack1.png",
      img4:"./img/SideLunge2.png",
    },
    { name: "Arm Circles",
      img1:"./img/ArmCircle1.png",
      img2:"./img/ArmCircle2.png",
      img3:"./img/ArmCircle1.png",
      img4:"./img/ArmCircle2.png",
    },
  ],
  /* Core */ [ // 10
    { name: "Sit Ups",
    ...
    { name: "Dolphin Dive",
      img1:"./img/Plank.png",
      img2:"./img/DolphinDive.png",
      img3:"./img/Plank.png",
      img4:"./img/DolphinDive.png",
    },
    { name: "Superman",
      img1:"./img/Superman.png",
      img2:"./img/Superman.png",
      img3:"./img/Superman.png",
      img4:"./img/Superman.png",
    },
    { name: "Reverse Crunch",
      img1:"./img/ReverseCrunch1.png",
      img2:"./img/ReverseCrunch2.png",
      img3:"./img/ReverseCrunch1.png",
      img4:"./img/ReverseCrunch2.png",
    },
    { name: "Boat Pose",
      img1:"./img/BoatPose.png",
      img2:"./img/BoatPose.png",
      img3:"./img/BoatPose.png",
      img4:"./img/BoatPose.png",
    },
  ],
  /* Last 1 Minute */ [ // 3
    { name: "Side Plank",
    ...
    { name: "Single Leg Deadlift",
      right1:"./img/SingleLegDeadliftRight.png",
      right2:"./img/SingleLegDeadliftRight.png",
